...
class Cadastrar4
{
    ...
    public function inserir($dados)
    {
        ...
        $sql = /** @lang text */
            "insert into produtos (id_produtos, nome, preco, quantidade, observacoes, administrador_id_administrador)values ('$id_produtos', '$nome', '$preco','$qtd', '$observacoes','$administrador')";
    ...
    public function carregarPorId($promocoes)
    {
        ...
        $sql = "select * from produtos where $promocoes = $promocoes";
