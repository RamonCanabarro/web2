...
<head>
    ...
    <link href="../../vendors/themes/explorer/theme.css" rel="stylesheet">
            ...
            <div class="nav_menu">
                ...
                <nav>
                    <ul class="nav navbar-nav">
                        <?php foreach($aCategorias as $categorias){?>
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <?php echo $categorias['nome'];?><span class=" fa fa-angle-down"></span>
                            </a>
